...
Kies zelf hoeveel hotels je wilt aanmaken, maar maak er minstens 2 en zorg dat er minstens 1 hotel a.d.h.v een queue werkt en minstens 1 a.d.h.v een mail. Per hotel moet er een thread gemaakt
worden die de reservatie van de queue of mail haalt, deze toevoegt aan z'n eigen database en de kamer klaarmaakt ENKEL ALS er nog capaciteit is. Zijn er geen kamers vrij dan wordt de
